...
<div class="container">
    ...
    <div class="form-group">
        <form action="<?= base_url(); ?>test/Passing_data/create_db" method="post">
            <!--<label for="comment">Comment : </label>-->
            <input type="text" class="form-control" name="db_name" placeholder="Nama database">
            <input type="submit" class="btn btn-primary status-btn right" id="submit" value="Create DB">
        </form>
    </div>
</div>
</body>
