...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <button type="button" class="btn btn-primary">Timeline <span class="badge"><?= count($result)?></span></button>
            <hr>
            <?php
                //Get Status
                foreach($result as $r) {
                    echo "<div>";
                        echo "<h1>" . $r['message'] . "</h1>";
                        echo "<span>" . $r['tanggal'] . "</span>";
                        echo "<span>" . " (ID = " . $r['status_id'] . ")" . "</span>";
                    echo "</div>";
                    //Get Comment
